 ...
 * The CompilationEngine class takes Jack tokens from the JackTokenizer and compiles them
 * into XML code representing the syntax of the Jack programming language.
 * 
 */
import java.io.File;
...
public class CompilationEngine {
    ...
    public void compileSubRoutine() {
        ...
        try {
            ...
            // subroutinedec tag
            if ((bFirstRoutine) && (jtoken.keyWord().equals("function") || jtoken.keyWord().equals("method")
                    || jtoken.keyWord().equals("constructor"))) {
                bFirstRoutine = false;
            ...
            // if there is an identifier in the subroutine statement position 2 e.g.
            // function Square getX()
            if (jtoken.tokenType().equals("IDENTIFIER")) {
                fw.write("<identifier> " + jtoken.identifier() + " </identifier>\n");
                jtoken.advance();
            }
            // if keyword instead for subroutine statement position 2 e.g. function int
            // getX()
        ...
        try {
            ...
            if (jtoken.tokenType().equals("IDENTIFIER")) {
                ...
                // this true null or false
                        ...
                        && (jtoken.keyWord().equals("this") || jtoken.keyWord().equals("null")
